...
import numpy as np
train_x=sparse.load_npz("./npz/train_value_set_x.npz")
test_x=sparse.load_npz("./npz/test_value_set_x.npz")
...
train_prob.to_csv("./stacking_csv/cv10/train%d_rf_train_prob_cv10_%f.csv"%(train_num,score),index=False)
test_prob.to_csv("./stacking_csv/cv10/train%d_rf_test_prob_cv10_%f.csv"%(train_num,score),index=False)
